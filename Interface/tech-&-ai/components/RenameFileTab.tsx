  ...
  return (
    <div className="h-full flex flex-col items-center justify-center p-8 relative">
       ...
       <div className="bg-[#18181b] p-8 rounded-[2rem] border border-zinc-800 mb-8 shadow-[0_20px_40px_rgba(0,0,0,0.5)] relative z-10">
          <FileEdit className="w-16 h-16 text-zinc-600" />
       </div>

       <h2 className="text-3xl font-bold text-zinc-100 mb-3 relative z-10 tracking-tight">Đổi Tên File</h2>
       ...
       <p className="text-zinc-500 text-center max-w-md leading-relaxed relative z-10 font-medium">
         Tính năng <strong>Đổi Tên File</strong> đang được đội ngũ <span className="text-zinc-200 font-bold">Lozy MMO</span> phát triển. 
