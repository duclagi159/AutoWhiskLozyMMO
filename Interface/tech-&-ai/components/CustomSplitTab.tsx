...
const CustomSplitTab: React.FC = () => {
  return (
    <div className="h-full flex flex-col items-center justify-center p-8 relative">
       ...
       <h2 className="text-3xl font-bold text-zinc-100 mb-3 relative z-10 tracking-tight">Tách Theo Yêu Cầu</h2>
       ...
       <p className="text-zinc-500 text-center max-w-md leading-relaxed relative z-10 font-medium">
         Tính năng <strong>Tách Theo Yêu Cầu</strong> đang được đội ngũ <span className="text-zinc-200 font-bold">Lozy MMO</span> phát triển. 
